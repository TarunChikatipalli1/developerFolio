...
import profilePic from "../../assets/images/profile.png"; // Ensure this path is correct
    ...
    <Fade bottom duration={1000} distance="20px">
      <div className="main contact-margin-top" id="contact">
        <div className="contact-div-main">
          ...
          {/* Replace Lottie Animation with Your Photo */}
          <div className="contact-image-div">
            <img alt="Tarun Chikatipalli" src={profilePic} className="contact-profile-pic" />
          </div>
        </div>
      </div>
    </Fade>
